public class UserPojo1 {
    ...
    public UserPojo1(String name, String functionality, String performance, String usability, String cost, String value, String environmentalEffect, String customerFeedback) {
        this.name = name;
