...
<body>
	<nav>
		...
		<ul>
			...
			<li><a class="active" href="Viewer.jsp">Viewer</a></li>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" href="#products">User Products</a></li>
										...
										<tr>
											<form action="UserUpdate1" method="post">
												...
												<td><button type="submit" name="button"
														value="reportbutton">Report</button></td>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<table>
										...
										%>
										<tr>
											<form action="AnalystController1" method="post">
												<td><input type="text" name='id' value='<%=name%>'
													readonly></td>
												<td><%=functionality%></td>
												<td><%=performance%></td>
												<td><%=usability%></td>
