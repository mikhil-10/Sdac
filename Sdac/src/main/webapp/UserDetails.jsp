	...
	<div class="container">
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" href="#userDetails">User Details</a></li>
				
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#products">Users Products</a></li>
				
			<li class="nav-item"><a class="nav-link" data-toggle="tab"
				href="#analyst">Analyst Products</a></li>
			...
			<div class="tab-content">
				<div id="userDetails" class="tab-pane fade show active">
					...
					<table>
						...
						%>
						<tr>
							<form action="ChangeRollController" method="post">
								<td><input type="text" name='id' value='<%=fullName%>'
									readonly></td>
								...
								<td><select name="usertype">
										<option value="user"
											<%=type.equals("user") ? "selected" : ""%>>User</option>
										<option value="analyst"
											<%=type.equals("analyst") ? "selected" : ""%>>Analyst</option>
								</select></td>
									...
									<tr>
										<form action="UserUpdate1" method="post">
											...
											<td><button type="submit" name="button"
													value="addbutton">Add</button></td>
											<td><button type="submit" name="button"
													value="updatebutton">Update</button></td>
											<td><button type="submit" name="button"
													value="deletebutton">Delete</button></td>
				...
				<div id="analyst" class="tab-pane fade">
					...
					try {
						...
						while (resultSet.next()) {
							...
							String cost = resultSet.getString("cost");
							String value = resultSet.getString("value");
							String environmentalEffect = resultSet.getString("environmentalEffect");
					%>
					<tr><form action="AnalystController1" method="post">
						...
						<td><%=value%></td>
						<td><%=environmentalEffect%></td>
						<td><a href="AnalystAdd.jsp"><input type="button" value="Add" onclick=""></a></td>
						<td><a href="AnalystUpdate.jsp"><input type="button" value="Upadte" onclick=""></a></td>
            <td><a href="Analysterror.jsp"><input type="button" value="Delete" onclick=""></a></td>
						<td><a href="Analysterror.jsp"><input type="button" value="Report" onclick=""></a></td>
