			...
			<div id="userDetails" class="tab-pane fade show active">
				...
				<table>
					...
					<tr><form action="AnalystController1" method="post">
						...
						<td><button type="submit" name="btn" value="addbutton">Add</button></td>
						<td><button type="submit" name="btn" value="updatebutton">Update</button></td>
           				 <td><button type="submit" name="btn" value="deletebutton">Delete</button></td>
           				 <td><button type="submit" name="btn" value="report">Report</button></td>
